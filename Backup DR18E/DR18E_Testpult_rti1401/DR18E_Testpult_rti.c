...
static void rti_mdl_initialize_io_boards(void)
{
  ...
  can_type1_msg_M2[CANTP1_M2_C1_RX_STD_0X222] = can_tp1_msg_rx_register
    (can_type1_channel_M2_C1, 2, 546, CAN_TP1_STD, (CAN_TP1_DATA_INFO|
      CAN_TP1_DATA_INFO|CAN_TP1_TIMECOUNT_INFO|CAN_TP1_TIMECOUNT_INFO),
     CAN_TP1_NO_SUBINT);
  ...
  can_type1_msg_M2[CANTP1_M2_C1_RX_STD_0X16A] = can_tp1_msg_rx_register
    (can_type1_channel_M2_C1, 1, 362, CAN_TP1_STD, (CAN_TP1_DATA_INFO|
      CAN_TP1_DATA_INFO|CAN_TP1_TIMECOUNT_INFO|CAN_TP1_TIMECOUNT_INFO),
     CAN_TP1_NO_SUBINT);
  ...
  can_type1_msg_M2[CANTP1_M2_C1_RX_STD_0X326] = can_tp1_msg_rx_register
    (can_type1_channel_M2_C1, 4, 806, CAN_TP1_STD, (CAN_TP1_DATA_INFO|
      CAN_TP1_DATA_INFO|CAN_TP1_TIMECOUNT_INFO|CAN_TP1_TIMECOUNT_INFO),
     CAN_TP1_NO_SUBINT);
  ...
  can_type1_msg_M2[CANTP1_M2_C1_RX_STD_0X244] = can_tp1_msg_rx_register
    (can_type1_channel_M2_C1, 3, 580, CAN_TP1_STD, (CAN_TP1_DATA_INFO|
      CAN_TP1_DATA_INFO|CAN_TP1_TIMECOUNT_INFO|CAN_TP1_TIMECOUNT_INFO),
     CAN_TP1_NO_SUBINT);
  ...
  /* ... Register message */
  can_type1_msg_M1[CANTP1_M1_C1_TX_STD_0X104] = can_tp1_msg_tx_register
    (can_type1_channel_M1_C1, 2, 260, CAN_TP1_STD, CAN_TP1_TIMECOUNT_INFO,
     CAN_TP1_NO_SUBINT, 0, CAN_TP1_TRIGGER_MSG, CAN_TP1_TIMEOUT_NORMAL);

  /* dSPACE RTICAN TX Message Block: "INV_1_TX" Id:259 */
  /* ... Register message */
  can_type1_msg_M1[CANTP1_M1_C1_TX_STD_0X103] = can_tp1_msg_tx_register
    (can_type1_channel_M1_C1, 1, 259, CAN_TP1_STD, (CAN_TP1_TIMECOUNT_INFO|
      CAN_TP1_TIMECOUNT_INFO|CAN_TP1_TIMECOUNT_INFO), CAN_TP1_NO_SUBINT, 0,
     CAN_TP1_TRIGGER_MSG, CAN_TP1_TIMEOUT_NORMAL);
  ...
  can_type1_msg_M1[CANTP1_M1_C1_RX_STD_0X111] = can_tp1_msg_rx_register
    (can_type1_channel_M1_C1, 4, 273, CAN_TP1_STD, (CAN_TP1_DATA_INFO|
      CAN_TP1_DATA_INFO|CAN_TP1_TIMECOUNT_INFO|CAN_TP1_TIMECOUNT_INFO),
     CAN_TP1_NO_SUBINT);
  ...
  /* ... Register message */
  can_type1_msg_M1[CANTP1_M1_C2_TX_STD_0X106] = can_tp1_msg_tx_register
    (can_type1_channel_M1_C2, 3, 262, CAN_TP1_STD, CAN_TP1_TIMECOUNT_INFO,
     CAN_TP1_NO_SUBINT, 0, CAN_TP1_TRIGGER_MSG, CAN_TP1_TIMEOUT_NORMAL);

  /* dSPACE RTICAN TX Message Block: "INV_2_TX" Id:260 */
  /* ... Register message */
  can_type1_msg_M1[CANTP1_M1_C2_TX_STD_0X104] = can_tp1_msg_tx_register
    (can_type1_channel_M1_C2, 2, 260, CAN_TP1_STD, (CAN_TP1_TIMECOUNT_INFO|
      CAN_TP1_TIMECOUNT_INFO|CAN_TP1_TIMECOUNT_INFO), CAN_TP1_NO_SUBINT, 0,
     CAN_TP1_TRIGGER_MSG, CAN_TP1_TIMEOUT_NORMAL);
  ...
  can_type1_msg_M1[CANTP1_M1_C2_TX_STD_0X102] = can_tp1_msg_tx_register
    (can_type1_channel_M1_C2, 0, 258, CAN_TP1_STD, (CAN_TP1_TIMECOUNT_INFO|
      CAN_TP1_TIMECOUNT_INFO|CAN_TP1_TIMECOUNT_INFO|CAN_TP1_DELAYCOUNT_INFO),
     CAN_TP1_NO_SUBINT, 0, CAN_TP1_TRIGGER_MSG, CAN_TP1_TIMEOUT_NORMAL);
  ...
  can_type1_msg_M1[CANTP1_M1_C2_RX_STD_0X112] = can_tp1_msg_rx_register
    (can_type1_channel_M1_C2, 5, 274, CAN_TP1_STD, (CAN_TP1_DATA_INFO|
      CAN_TP1_DATA_INFO|CAN_TP1_TIMECOUNT_INFO|CAN_TP1_TIMECOUNT_INFO),
     CAN_TP1_NO_SUBINT);
