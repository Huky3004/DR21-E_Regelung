/************************ dSPACE target specific file *************************
   ...
   Include file .\DR18E_Testpult_rti1401\DR18E_Testpult_th.c :

   Task Configuration file for model : DR18E_Testpult

   RTI1401 7.8 (02-May-2017)/2.17
   01-Aug-2018 17:18:47
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\DR18E_Testpult_rti1401\DR18E_Testpult_th.c is for ST).
# endif
