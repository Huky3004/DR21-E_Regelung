...
#
#  $RCSfile: DR18E_Testpult.mk $ $Revision: 2.95 $ $Date: 2016/03/14 14:26:10CET $
...
COMPUTER                       = PCWIN64
MODEL                          = DR18E_Testpult
MODULES                        = DR18E_Testpult_data.c DR18E_Testpult_trc_ptr.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c rt_zcfcn.c flightrecsetup.c DsFlRecUSB.c
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 8
...
RTWCUST_INCLUDES = \
	...
	"$(START_DIR)\DR18E_Testpult_rti1401" \
	"$(START_DIR)\Model"
